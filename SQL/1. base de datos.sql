...
/*  Created On : 12-dic.-2022 12:05:56 p. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	q_numeroTelefono integer NOT NULL,
...
(
	...
	n_tipoDocumento varchar(4) NOT NULL,
	n_tipoDocumentoMensajero varchar(4) NULL
)
;
...
(
	...
	n_apellidos varchar(50) NOT NULL,
	f_fechaDeNacimiento date NOT NULL,
	k_numeroDeTelefono integer NOT NULL,
	o_correo varchar(50) NOT NULL,
...
(
	...
	f_horaFin time(6) without time zone NOT NULL,
